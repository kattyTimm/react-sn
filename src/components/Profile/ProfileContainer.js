...
import {getProfileThunk, updateStatusThunk, setStatusThunk, savePhoto} from '../../ProfileReducer';
...
export default compose(
 	connect(mapStateToProps, {getProfileThunk, setStatusThunk, updateStatusThunk, savePhoto}),
 	 withRouter,
  //   WithAuthRedirect,
 	)(ProfileContainer);
